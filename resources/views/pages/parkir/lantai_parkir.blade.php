                                    ...
                                    <tr class="intro-x">
                                        ...
                                        <td class="table-report__action w-50">
                                            <div class="flex justify-center items-center">
                                                ...
                                                <a class="flex items-center text-theme-6" href="/delete-lantai-parkir/{{$item->id}}" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');">
    ...
    $("#addbtn").click(function(e){
        ...
        $.ajax({
           ...
           success:function(data){
             ...
             window.location="{{ url('lantai-parkir') }}";
...
// alert('ubah');
        e.preventDefault();
        var id_lantai = $("input[name=id_lantai"+ids+"]").val();
        ...
        $.ajax({
           ...
           url:"{{ url('update-lantai-parkir/{id_lantai}') }}",

           data:{ "_token": "{{ csrf_token() }}",id_lantai:id_lantai,editnama:editnama},
